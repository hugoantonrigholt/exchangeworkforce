...
<meta property=”og:title” content="Exchange Workforce - Alle vacatures" />
<meta property=”og:description” content=" Bekijk alle vacatures van Exchange Workforce " />
<meta property=”og:url” content=https://www.exchange-workforce.eu/vacatures />
<meta property=”og:site_name” content="Exchange Workforce" />
<title>Exchange Workforce - Vacatures</title>
    ...
    <div class="page-container">
        <div class="row">
                        ...
                        <form action="{{ route('vacatures') }}" method="GET">
                            <div class="industry mb-6">
                                ...
                                <input class="form-check-input" type="checkbox" name="industry"
                                    id="{{ $industry->industry }}" value="{{ $industry->industry }}">
            ...
            <div class="col-12 col-md-8">
                @if ($top_vacancies->count())
                <div class="col-12 card m-0 p-1 shadow-light-lg accordion py-5 mb-8 d-none d-md-block">
                        ...
                        <div class="row">
                            ...
                            <div class="col ml-n4">
                                ...
                                <h2 class="font-weight-bold mb-0">
                                    <span class="text-primary">Uitgelichte</span> vacatures

                                </h2>
                                <!-- Badge -->
                                <span class="badge badge-pill badge-dark-soft mt-2">
                                    <span class="h6 text-uppercase">
                                        @if ($top_vacancies->count() == 1)
                                        {{ $top_vacancies->count() }} uitgelichte vacature
                                        @else
                                        {{ $top_vacancies->count() }} uitgelichte vacatures
                                        @endif
                                    </span>
                                </span>
                            </div>
                            <div class="col-auto">
                                <a class="btn btn-dark" href="/uitgelichte-vacatures">
                                    Bekijk meer
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-12 p-0">
                    ...
                    <div class="row mb-6 mb-md-8 mx-1">
                        ...
                        <div class="col ml-n4">
                            ...
                            <!-- Heading -->
                            <h2 class="font-weight-bold mb-0">
                                <span class="text-primary">Alle</span> vacatures
                            </h2>
                            ...
                            <span class="badge badge-pill badge-dark-soft mt-2">
                                <span class="h6 text-uppercase">
                                    ...
                                    {{ $vacancies->count() }} vacature
                                    @else
                                    {{ $vacancies->count() }} vacatures
                                    @endif
                                </span>
                            </span>
                            ...
                            <div class="card shadow-light-lg accordion" id="helpAccordionOne">
                                <div class="list-group">
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none">{{ $vacancy->employment_function->employment_function }}
                                        </td>
                                        ...
                                        <td class="list-group-item px-6 py-5">
                                            ...
                                            <!-- Collapse -->
                                            <div class="collapse" id="vacancy_{{ $vacancy->id }}"
                                                ...
                                                <div class="py-5">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <!-- Detail -->
                                                        <a href="/vacatures/{{ $vacancy->id }}"
                                                            class="btn btn-dark mt-6">
                                                            Bekijken
                                                        </a>
                                                    </div>
                                                </div>
