...
<meta property=”og:title” content="Exchange Workforce - Uitgelichte vacatures" />
<meta property=”og:description” content=" Bekijk alle uitgelichte vacatures van Exchange Workforce " />
<meta property=”og:url” content=https://www.exchange-workforce.eu/uitgelichte-vacatures />
<meta property=”og:site_name” content="Exchange Workforce" />
<title>Exchange Workforce - Uitgelichte Vacatures</title>
            ...
            <div class="row mb-6 mb-md-8">
               ...
               <div class="col ml-n4">
                  ...
                  <h2 class="font-weight-bold mb-0">
                     <span class="text-primary">TOP</span> vacatures
                  </h2>
                           ...
                           <td class="list-group-item px-6 py-5">
                              ...
                              <div class="collapse" id="vacancy_{{ $vacancy->id }}" data-parent="#helpAccordionOne">
                                 <div class="py-5">
                                    ...
                                    <div class="d-flex align-items-center">
                                       <!-- Detail -->
                                       <a href="/vacatures/{{ $vacancy->id }}" class="btn btn-primary mt-6">
                                          Bekijken
                                       </a>
                                    </div>
                                 </div>
